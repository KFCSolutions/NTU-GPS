...
CXX           = g++
DEFINES       = 
CFLAGS        = -pipe -O2 -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong -fno-plt -Wall -Wextra -fPIC $(DEFINES)
CXXFLAGS      = -pipe -std=c++11 -Wall -Wfatal-errors -O2 -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong -fno-plt -std=gnu++11 -Wall -Wextra -fPIC $(DEFINES)
...
DISTDIR = /home/movinggun/Downloads/gps-master/.tmp/nmea-tests1.0.0
LINK          = g++
...
parseNMEA.o: src/parseNMEA.cpp headers/earth.h \
		headers/position.h \
		headers/types.h \
		headers/parseNMEA.h
